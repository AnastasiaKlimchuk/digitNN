from utils import read_data, split_test, accuracy, one_hot, N_CLASSES
import Model
...
parameters = Model.L_layer_model(train_set_x, train_set_y, layers_dims, learning_rate=0.5, num_iterations=12000,
                                 print_cost=True)
